...
+ Wenden Sie dann die Label-Strategie mit `left_join()` an:
+ Erstellen Sie einen Label-`data.frame` mit den Ausprägungen und den gewünschten Beschriftungen. (Sie können die Labels der Variable `F411_01` mit `attributes(etb18_kap5$F411_01)$labels` nachsehen.) 
