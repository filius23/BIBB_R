...
Wenn wir jetzt aber die beiden Modelle `m1` und `m3` vergleichen, sehen wir unterschiedliche Fallzahlen:
...
Es zeigt sich, dass in Modell 2 mit `edu_fct` 1 Fall verloren geht. Woran liegt das?
...
#| out-width: "50%"
#| out-height: "50%"
modelplot(m4,coef_map = c("var1" = "Name für var1",
...
#| out-width: "50%"
#| out-height: "50%"
modelplot(list("Modell 1"=m1_m4vars,
               "Modell 4"=m4),
