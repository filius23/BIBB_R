...
Diese Option wird häufig verwendet, wenn lediglich eine Funktion aus einem Paket einmalig verwendet wird und der Rest des Pakets nicht hilft.
...
filter(dat1, studs <= 10000)
filter(dat1,studs > 10000 | prof < 200) # mehr als 10.000 Studierende *oder* weniger als 200 Professuren
...
Alternativ könnten wir auch mit folgendem Befehl ein .Rproj - Projekt erstellen (hier ein Beispiel für den [Aufruf eines Pakets mit `::`](#pkgdoublecolon)):
```{r, eval = F, echo=T}
...
-   Lassen Sie sich nur Zeilen der Hochschulen anzeigen, die vor 1900 gegründet wurden.
-   Lassen Sie sich nur Zeilen der Hochschulen mit Promotionsrecht anzeigen.

[Zurück nach oben](#ue2)


## Übungen 3 {#data3}

-   Verwenden Sie weiterhin den Datensatz aus Übung 1 & 2.
-   Lassen Sie sich nur Zeilen der Hochschulen anzeigen, die 1971, 1457 oder 1995 gegründet wurden.
...
-   Lassen Sie sich die Variablennamen von `etb` mit `names()` anzeigen!
