# -------------------- #
# Beispiel: aus Rohdaten einen data.frame machen
# Arbeitslosenstatistik von Destatis 
# https://www.regionalstatistik.de/genesis//online?operation=table&code=AI008-1
# -------------------- #
