...
```{r dplyr, echo = F, out.height="70%",out.width="70%", fig.align="center"}
...
Wir werden in diesem Kurs vor allem mit Paketen aus dem [tidyverse](tidyverse.org/) arbeiten. tidyverse ist eine Sammlung an Paketen, die übergreifende Syntaxlogik haben und so besonders gut miteinander harmonisieren und eine riesige Bandbreite an Anwendungsfällen abdecken. Mit
```{r,eval =FALSE}
