...
## Überblick: wie lese ich welches Format ein?

```{r,echo=F}
options(knitr.kable.NA = '')
readxl::read_xlsx(path = "02_readin.xlsx",sheet = 1) %>% 
  kbl(caption = "Einlesebefehle", booktabs = T,escape = F,format = "html") %>% 
...
Wir können Daten natürlich auch exportieren:
...
knitr::include_graphics("D:/oCloud/RFS/images/104_install-packages.jpg")
```
...
## Häufige Fehlermeldungen
 ...
 <!-- https://nickch-k.github.io/DataCommSlides/Lecture_04_Common_R_Problems.html -->