...
Um die Grundlagen kennenzulernen, visualisieren wir die gerade erstellte Kontingenztabelle:
```{r}
...
ggplot(data = etb18 , 
  ...
  scale_fill_manual(values = c("navajowhite","navy"),
                    breaks = c(1,2), labels = c("Männer", "Frauen")) +
  scale_x_continuous(breaks = 1:4 , labels = c("ohne", "duale Ausb.","Aufstiegsfortb.","FH/Uni")) +
  # str_wrap(name,20)
...
ggplot(data = etb18, aes(x = zpalter, y = az)) + geom_point() + facet_grid(~S1) + 
